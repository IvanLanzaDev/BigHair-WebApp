...
<body>
    ...
    <div class="message-container text-center">
      ...
      <small>
        <p class="lead"> O agendamento solicitado foi <span class="text-danger"> desmarcado! </span>
      </small>

      <div class="d-flex flex-row">
      <a href="../schedules" class="btn btn-success btn-lg btn-block"> Ver agendamentos </a>
      </div>
    </div>
